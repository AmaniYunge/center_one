                ...
                <ul class="chats">
                    ...
                    <li class="by-me">
                        ...
                        <div class="avatar pull-left">
                            <img src="administrator/img/user.jpg" alt=""/>
                        </div>
                    ...
                    <li class="by-other">
                        ...
                        <div class="avatar pull-right">
                            <img src="administrator/img/user22.png" alt=""/>
                        </div>
    ...
    <div class="widget">
        ...
        <div class="widget-content referrer">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    <td><img src="administrator/img/icons/chrome.png" alt="" />
                    <td>Google Chrome</td>
                    <td>3,005</td>
                </tr>
                <tr>
                    <td><img src="administrator/img/icons/firefox.png" alt="" />
                    <td>Mozilla Firefox</td>
                    <td>2,505</td>
                </tr>
                <tr>
                    <td><img src="administrator/img/icons/ie.png" alt="" />
                    <td>Internet Explorer</td>
                    <td>1,405</td>
                </tr>
                <tr>
                    <td><img src="administrator/img/icons/opera.png" alt="" />
                    <td>Opera</td>
                    <td>4,005</td>
                </tr>
                <tr>
                    <td><img src="administrator/img/icons/safari.png" alt="" />
                    <td>Safari</td>
                    <td>505</td>
                </tr>
            </table>
